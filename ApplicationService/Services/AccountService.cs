...
namespace ApplicationService.Services
{
    ...
    {
        private static readonly GetUserRepository Repository = new GetUserRepository();
        ...
        public AccountDto GetAccountInfo(AccountCommand accountCommand)
        {
            var user = _userList.SingleOrDefault(a => a.Username == accountCommand.Username);
            return new AccountDto() {Address = user.Address, Name = user.Name, Phone = user.Phone};
        }
    }
}